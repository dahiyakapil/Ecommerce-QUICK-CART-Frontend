...
import newsLetterImage from "../images/images/newsletter.png"
          ...
          <div className="row">
            <div className="col-4">
              ...
              <div>
                ...
                QuickCart Pvt Ltd 
                  <br /> NBT Nagar, Banjara Hills
                  <br /> Hyderabad, Telangana 500034
                </address>
                <a
                  href="tel:+99652700300"
                  className="mt-3 text-white mb-1 d-block mb-3"
                >
                  +91 8168035828
                </a>
                <a
                  href="mailto:sravyanthkotha@gmail.com"
          ...
          <div className="row">
            <div className="col-12">
              <p className="text-center text-white mb-0">
                &copy; {new Date().getFullYear()} Powered By Quickcart.com
              </p>
            </div>
          </div>
        </div>
